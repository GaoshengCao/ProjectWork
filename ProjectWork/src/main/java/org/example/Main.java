...
//        System.out.println(db.getAllChampions());


    }
    static void popilateDatabase(){
        ...
        for (Champion champion : champions) {
            dataBase.insertChampion(champion);
            dataBase.insertCounter(champion);
            dataBase.insertBuild(champion);
        }
